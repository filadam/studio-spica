...
$(document).ready(function () {
  ...
  var pinOverlayHeight = $('.pin-spacer').outerHeight(true);
  bg.css("height", pinOverlayHeight + "px"); //    stars background height

  var pinOverlayWidth = $('.intro').outerWidth(true);
  bg.css("width", pinOverlayWidth + "px");
});

/***/ }),

/***/ "./assets/js/horizon-timeline.js":
/*!***************************************!*\
  !*** ./assets/js/horizon-timeline.js ***!
  \***************************************/
/***/ (() => {
...
var moonBackground = document.querySelector('.moon-bg');
var introRocketTimeline = gsap.timeline({
  scrollTrigger: {
    trigger: intro,
    pin: true,
    pinSpacing: "margin",
    start: "".concat(intro.offsetHeight / 2) + " 50%",
    end: "+=750px 20%",
    scrub: 2
  }
});
introRocketTimeline.to(rocket, {
  duration: 5,
  scale: 0.7,
  motionPath: {
    path: "#path",
...
/* harmony import */ var _intro_timeline__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./intro-timeline */ "./assets/js/intro-timeline.js");
/* harmony import */ var _intro_timeline__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_intro_timeline__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _horizon_timeline__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./horizon-timeline */ "./assets/js/horizon-timeline.js");
/* harmony import */ var _horizon_timeline__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_horizon_timeline__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loader */ "./assets/js/loader.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_loader__WEBPACK_IMPORTED_MODULE_7__);
// Import style
 // Import jQuery
